...
namespace WindowsFormsApplication2.Forms
{
    public partial class Venta : Form
    {
        ...
        private void Venta_Load(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter mdaDatos2 = new MySqlDataAdapter("SELECT Folio,Producto,Canprodu,Cantidadpagar,Le_atendio FROM Venta where borrado = 1", cnn);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            for (i = 0; i <= datagrid2.RowCount - 1; i++)
            {
                for (j = 0; j <= datagrid2.ColumnCount - 1; j++)
                {
        ...
        {
            int resultado = Class.ventadal.acatualizar();
            if (resultado > 0)
            {
                MessageBox.Show("Venta ha sido vaciado.", "Eliminado", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
