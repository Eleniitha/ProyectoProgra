        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
               ...
               string NOMBRe = textBox1.Text.Trim(); 
                ...
                MySqlCommand comando = new MySqlCommand(string.Format("UPDATE usuarios set nombre = '"+NOMBRe+"' where codigo = '"+clave+"'"), conexion);
            ...
            if (textBox2.Text != "")
            {
                ...
                MySqlCommand comando = new MySqlCommand(string.Format("UPDATE usuarios set contraseña = '" + NOMBRe + "' where codigo = '" + clave + "'"), conexion);
           ...
           //              MySqlConnection conexion = Class.BdComun.ObtenerConexion();
            //
              //  MySqlCommand comando = new MySqlCommand(string.Format("UPDATE usuarios set codigo = '" + NOMBRe + "' where c = '" + clave + "'"), conexion);
            //
              //  retorno = comando.ExecuteNonQuery();
                //conexion.Close();
            ...
            if (textBox4.Text != "")
            {
                ...
                MySqlCommand comando = new MySqlCommand(string.Format("UPDATE usuarios set ocupacion = '" + NOMBRe + "' where codigo = '" + clave + "'"), conexion);
            ...
            if (textBox6.Text != "")
            {
                ...
                MySqlCommand comando = new MySqlCommand(string.Format("UPDATE usuarios set telefono = '" + NOMBRe + "' where codigo = '" + clave + "'"), conexion);
