...
namespace WindowsFormsApplication2.Class
{
    class usuariosdal
    {
        ...
        public static int acatualizarn(string NOMBRe, int Codigo)
        {

            int retorno = 0;
            MySqlConnection conexion = BdComun.ObtenerConexion();

            MySqlCommand comando = new MySqlCommand(string.Format("UPDATE usuarios set nombre = '{0}' where codigo = '{1}'",NOMBRe, Codigo), BdComun.ObtenerConexion());
